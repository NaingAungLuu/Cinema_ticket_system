...
import cinema_ticket_system.GUIs.Admin.Admin_Manage_Seat_Plan;
...
public class Sales_Seats extends JPanel{
    ...
    public Sales_Seats(int MovieNo , boolean is3D)
    {
        ...
        lblMovieType.setBackground(Color.decode("#242B40"));
        //Constructor for Screen Label
        JPanel pnlScreen = new JPanel();
        pnlScreen.setBounds(360 , 110 , 612 , 35);
        ...
        lblScreen.setVerticalAlignment(SwingConstants.CENTER);
        lblScreen.setForeground(Color.white);
        lblScreen.setBackground(Color.decode("#242B40"));
        ...
        lblClassC.setBackground(Color.decode("#242B40"));
        ...
        lblClassB.setBackground(Color.decode("#242B40"));
        ...
        lblClassA.setBackground(Color.decode("#242B40"));
        ...
        lblClassS.setBackground(Color.decode("#242B40"));
