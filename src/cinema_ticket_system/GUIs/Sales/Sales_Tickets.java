...
public class Sales_Tickets extends JPanel{
    ...
    public Sales_Tickets()
    {
        ...
        imgMovie1.setIcon(Utils.scaleImage(imgMovieone , 269 , 381));
        ...
        imgMovie2.setIcon(Utils.scaleImage(imgMovietwo , 269 , 381));
        ...
        imgMovie3.setIcon(Utils.scaleImage(imgMoviethree , 269 , 381));
